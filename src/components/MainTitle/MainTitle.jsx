...
const MainTitle = () => {
	...
	return (
		<section className='relative mt-12 flex flex-col justify-center items-center space-y-4 py-5 px-3  bg-cover bg-center h-80 md:h-96 md:px-1' style={{ backgroundImage } }>
