...
const ContactFrom = () => {
    ...
    return (
        <section className='pb-12 pt-5 bg-[#FFF] px-3'>
            <h3 className=' text-2xl text-center text-[#173e49] md:text-3xl'>Contacto</h3>
            <p className='text-md py-2 font-medium text-center md:pb-8'>Complete el siguiente formulario y nos pondremos en contacto lo antes posible. ¡Muchas gracias!</p>
